...
namespace Ecommerce_store.Controllers
{
    public class AccountsController : Controller
    {
        ...
        public AccountsController(Ecommerce_storeContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Account != null ? 
                          ...
                          Problem("Entity set 'Ecommerce_storeContext.Account'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Ecommerce_storeContext.Account'  is null.");
            }
            var account = await _context.Account.FindAsync(id);
            if (account != null)
            {
